...
void iniTrain()
{
    ...
    availTrains[0].TDate = "24-Dec-2024";
    ...
    availTrains[1].TDate = "26-Dec-2024";
    ...
    availTrains[3].TDate = "01-Jan-2025";
    ...
    availTrains[4].TDate = "31-Dec-2024";
...
login:
    ...
    if (user == "nobita" && password == "nobi123" || user == "shizuka" && password == "shizu123")
    {
...
relog:
    ...
    cout << "\n\n\t\t\t\t\t\t--------------------";
    Sleep(500);
    cout << "\n\n\t\t\t\t     Hina Tufail       01-134232-074";
    Sleep(1000);
    cout << "\n\n\t\t\t\t     Kulsoom Qasim     01-134232-086";
    Sleep(2000);
    cout << "\n\n\t\t\t\t     Maham Munir       01-134232-092";
    Sleep(1000);
    cout << endl;
    system("cls");
log:
